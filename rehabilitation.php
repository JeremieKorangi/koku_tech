<?php include("inc/head.php") ?>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="intro-image">
                            <img src="assets/img/rehabilitation/img1.jpg" alt="Vue aérienne de la FICKIN" class="rounded-image">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="we-are-section pt-100 pb-70">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="we-are-item">
                            <img src="assets/img/rehabilitation/img1.jpg" alt="image">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="we-are-item">
                            <img src="assets/img/rehabilitation/img3.jpg" alt="image">
                    ...
                    <div class="col-lg-4 col-md-6 offset-md-3 offset-lg-0">
                        <div class="we-are-item">
                            <img src="assets/img/rehabilitation/img5.jpg" alt="image">
            ...
            <div class="we-are-shape">
                <div class="shape-1">
                    <img src="assets/img/we-are/shape-1.png" alt="image">
                </div>

                <div class="shape-2">
                    <img src="assets/img/we-are/shape-2.png" alt="image">
                </div>
            </div>
        </section>
        <!-- End We Are Two Area -->
...
<style>
/* Styles pour la page Mission & Vision FICKIN */
@import url('https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css');

/* Intro Section */
.mission-vision-intro-area {
    background: #fafafa;
}
